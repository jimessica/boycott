...
dataALL <- data.frame(
  "Companies" = c("Nike (NKE)", "United Parks and Resorts (PRKS)", "Starbucks (SBUX)"),
...
#| fig-cap: Changes in United Parks and Resorts Stock Price from One Week Before Blackfish was Released to One Week After Their Pledge to End Orca Breeding
#| echo: false
...
#| fig-cap: Changes in United Parks and Resorts During the Month SeaWorld First Announced they Were Impacted by the Release of 'Blackfish'
#| echo: false
...
```{r}
#| label: fig-spxPRKS
#| fig-cap: Changes in United Parks and Resorts Stock Price in Comparison with the S&P 500 index
#| echo: false
